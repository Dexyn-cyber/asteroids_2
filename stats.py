...
class Stats:
    ...
    def get_final_score(self):
        if self.kills != 0 or self.total_shot != 0:
            ...
            acc_rating = 0
        return f"""
        Total Final Score: {self.score} | Got a total of {self.kills} kills | {self.sm_kills} Were small, {self.med_kills} were medium, {self.big_kills} total were big targets. 
        {self.total_shot} Bullets. Accuracy Rating of {acc_rating}%
        """
